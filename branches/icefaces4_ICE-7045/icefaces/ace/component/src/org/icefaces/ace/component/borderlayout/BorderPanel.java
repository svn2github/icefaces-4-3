...
public class BorderPanel extends BorderPanelBase {

	private static final String OPTIMIZED_PACKAGE = "org.icefaces.ace.component.";
    // still need to review themeroller support
	public static final String PANEL_CENTER = "ui-layout-center ui-widget ui-widget-content ui-corner-all";
	public static final String PANEL_NORTH = "ui-layout-north ui-widget";
 	public static final String PANEL_SOUTH = "ui-layout-south ui-widget ui-widget-content ui-corner-all";
    public static final String PANEL_EAST = "ui-layout-east ui-widget ui-widget-content ui-corner-all";
 	public static final String PANEL_WEST = "ui-layout-west ui-widget ui-widget-content ui-corner-all";
 ...
 /*   @Override
    public void queueEvent(FacesEvent event) {
        ...
        if(isSelfRequest(context)) {
           ...
           //TODO refactor to include resizable event
