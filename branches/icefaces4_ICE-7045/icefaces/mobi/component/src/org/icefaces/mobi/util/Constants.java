...
public class Constants {
    ...
    public static final String THEME_PARAM = "org.icefaces.mobi.theme";
    public static final String THEME_FORMS_PARAM = "org.icefaces.mobi.themeForms";
    public static final String AUTO_UPDATE = "org.icefaces.mobi.autoUpdate";

    public final static String VERSION = "2.1.0-b01";
    public final static String LIBRARY = "icefaces.mobi";
