...
@MandatoryResourceComponent(tagName="scheduleExporter", value="org.icefaces.ace.component.scheduleexporter.ScheduleExporter")
public class ScheduleExporterRenderer extends CoreRenderer {
    private static final Random RANDOM = new Random();

    @Override
    public void decode(FacesContext facesContext, UIComponent component) {
		Map<String,String> requestParameterMap = facesContext.getExternalContext().getRequestParameterMap();
		ScheduleExporter exporter = (ScheduleExporter) component;
	...
	public void encodeBegin(FacesContext facesContext, UIComponent component) throws IOException {
		...
		String accesskey = exporter.getAccesskey();
		if (accesskey != null) writer.writeAttribute("accesskey", accesskey, null);
		
		StringBuilder onclick = new StringBuilder("new ice.ace.ScheduleExporter('" + clientId + "',");
	...
	public void encodeEnd(FacesContext facesContext, UIComponent component) throws IOException {
		...
		if (path != null) {
			writer.write("\nice.ace.ScheduleExporters['" + clientId + "'].url('" + path + "');");
		}
