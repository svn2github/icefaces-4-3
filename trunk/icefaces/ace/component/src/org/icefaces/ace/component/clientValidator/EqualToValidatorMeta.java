...
@Component(
        tagName         = "clientValidateEqualTo",
        componentClass  = "org.icefaces.ace.component.clientValidator.EqualToValidator",
        rendererClass   = "org.icefaces.ace.component.clientValidator.ValidatorRenderer",
        generatedClass  = "org.icefaces.ace.component.clientValidator.EqualToValidatorBase",
        extendsClass    = "javax.faces.component.UIComponentBase",
        componentType   = "org.icefaces.ace.component.EqualToValidator",
...
public class EqualToValidatorMeta extends UIComponentBaseMeta {
        @Property(tlddoc = "The ID of the other component.")
        private String to;
}
