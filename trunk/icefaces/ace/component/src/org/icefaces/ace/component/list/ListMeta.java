...
@ClientBehaviorHolder(events = {
    ...
    @ClientEvent(name="move", defaultRender="@all", defaultExecute="@this",
            javadoc="Fired when an item is moved within the List. The listener method for this event can take an event object of the type org.icefaces.ace.event.ListMoveEvent.",
            tlddoc ="Fired when an item is moved within the List. The listener method for this event can take an event object of the type org.icefaces.ace.event.ListMoveEvent."),
    @ClientEvent(name="migrate", defaultRender="@all", defaultExecute="@this",
            javadoc="Fired when an item is migrated to this List. The listener method for this event can take an event object of the type org.icefaces.ace.event.ListMigrateEvent.",
            tlddoc ="Fired when an item is migrated to this List. The listener method for this event can take an event object of the type org.icefaces.ace.event.ListMigrateEvent."),
