...
public class RadioButtonsMeta extends UISelectOneMeta {
    ...
    @Property(tlddoc = "Position of the individual radio button labels relative to their input fields. Supported values are \"left/right/top/bottom/inField/none\".", defaultValue="none")
