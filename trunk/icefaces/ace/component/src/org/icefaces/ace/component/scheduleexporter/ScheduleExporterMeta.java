...
@Component(
        tagName       = "scheduleExporter",
        componentClass  = "org.icefaces.ace.component.scheduleexporter.ScheduleExporter",
		rendererClass   = "org.icefaces.ace.component.scheduleexporter.ScheduleExporterRenderer",
        generatedClass  = "org.icefaces.ace.component.scheduleexporter.ScheduleExporterBase",
        extendsClass    = "javax.faces.component.UIComponentBase",
        componentType   = "org.icefaces.ace.component.ScheduleExporter",
        rendererType    = "org.icefaces.ace.component.ScheduleExporterRenderer",
		componentFamily  = "org.icefaces.ace.component",
		tlddoc = "Utility to export event data from an ace:schedule component as an Excel, PDF, XML or CSV document. Only the events in the current view of the ace:schedule component are exported. If the ace:schedule component is working in the non-lazy mode, there's the option to export all the events in the component value. This component renders an HTML button. More components and HTML elements can be nested inside this tag to give a different look to the button." +
                 "<p>For more information, see the " +
                 "<a href=\"http://wiki.icefaces.org/display/ICE/ScheduleExporter\">ScheduleExporter Wiki Documentation</a>."
)
@ICEResourceLibrary(ACEResourceNames.ACE_LIBRARY)
@ICEResourceDependencies({
	@ICEResourceDependency(name = "scheduleexporter/scheduleexporter.js")
})
@ClientBehaviorHolder(events = {
	@ClientEvent(name="action", javadoc="Triggers when the button is clicked or pressed by any other means. By default, both this ace:scheduleExporter component and the target ace:scheudle component are executed in this ajax request.", tlddoc="Triggers when the button is clicked or pressed by any other means. By default, both this ace:scheduleExporter component and the target ace:schedule component are executed in this ajax request.", defaultRender="@all", defaultExecute="@this")
}, defaultEvent="action")
public class ScheduleExporterMeta extends UIComponentBaseMeta {

	@Property(required=Required.yes, tlddoc="Define the id of the ace:schedule component whose data will be exported.")
	...
	@Property(required=Required.no, tlddoc="Specifies an object that implements a custom format type to use instead of one of the built-in formats. When this attribute is specified, it will override the \"type\" attribute. The object must extend org.icefaces.ace.component.scheduleexporter.Exporter.")
	...
	@Property(required=Required.no, tlddoc="Determine whether the event field names should be included at the top of the file. This is not applicable when the attribute 'type' is set to 'xml'.", defaultValue="true")
