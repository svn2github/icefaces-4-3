...
public class CentralDataList {
	public static List<CategoryGroup> generate() {
		...
		toReturn.add(new CategoryGroup(msgs("menu.ace.group.validator.title"),
				new ComponentGroup("ace:clientValidateRequired", "RequiredValidator", "clientValidateRequired.html",
				...
				new ComponentGroup("ace:clientValidateLength", "LengthValidator", "clientValidateLength.html",
				...
				new ComponentGroup("ace:clientValidateValueRange", "ValueRangeValidator", "clientValidateValueRange.html",
				...
				new ComponentGroup("ace:clientValidateDecimal", "DecimalValidator", "clientValidateDecimal.html",
				...
				new ComponentGroup("ace:clientValidatePattern", "PatternValidator", "clientValidatePattern.html",
