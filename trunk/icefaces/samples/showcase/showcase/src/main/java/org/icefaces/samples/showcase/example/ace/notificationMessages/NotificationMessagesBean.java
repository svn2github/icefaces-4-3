...
package org.icefaces.samples.showcase.example.ace.notificationMessages;
...
@ManagedBean(name = NotificationMessagesBean.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class NotificationMessagesBean implements Serializable {
    public static final String BEAN_NAME = "notificationMessagesBean";
