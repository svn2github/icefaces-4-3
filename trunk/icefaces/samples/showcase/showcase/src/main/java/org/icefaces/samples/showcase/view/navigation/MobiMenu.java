...
@ApplicationScoped
public class MobiMenu extends org.icefaces.samples.showcase.metadata.context.Menu<MobiMenu>
        implements Serializable {

    public static final String BEAN_NAME = "MobiMenu";

    public MobiMenu() {
        super(MobiMenu.class);
    }
