...
@ManagedBean
@ApplicationScoped
public class PushBeanResources extends ComponentExampleImpl<PushBeanResources> implements Serializable {
    public PushBeanResources() {
        super(PushBeanResources.class);
    }
