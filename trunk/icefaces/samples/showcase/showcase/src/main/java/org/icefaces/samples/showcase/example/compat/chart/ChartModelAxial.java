...
public class ChartModelAxial extends AbstractChartData implements Serializable {
    ...
    public ChartModelAxial(String chartTitle,
        ...
        this(chartTitle, areaMapEnabled, axisOrientationEnabled,
             enableDynamicValues, enabledLengendPosition, true);
    }
    ...
    private void init() {
        // build default data
        double possibleNegative = allowNegative ? -36 : 36;
        
        double[][] doubleArray = {new double[]{350, 50, 400},
                new double[]{45, 145, 50},
                new double[]{possibleNegative, 6, 98},
    ...
    public void addData() {
        ...
        chartData.add(
                new double[]{getRandomDouble(100.0, 450.0),
                        getRandomDouble(50.0, 100.0),
                        getRandomDouble(250.0, 650.0)});
